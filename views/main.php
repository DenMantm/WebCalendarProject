...
<div class="tabcontrol2" data-role="tabcontrol">
   ...
   <div class="frames">
      ...
      <!--Dialog box for new meeting-->
          ...
          <!--end of new meeint here-->
        
        
         <!--Dialog box for Team meeting-->
                      ...
                      <div class="modal fade" id="newteammeeting" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                      <h4 class="modal-title" id="myModalLabel">Asseig Tasks to Teams Here</h4>
                                    </div>
        ...
        <!--end of dialog box for Team Meeting here-->
